...
static const _Control_Request_type_support_symbol_names_t _Control_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_control, srv, Control_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv_control, srv, Control_Request)),
  }
};
...
{
  return &::auv_control::srv::rosidl_typesupport_cpp::Control_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auv_control, srv, Control_Request)() {
  return get_message_type_support_handle<auv_control::srv::Control_Request>();
}
...
static const _Control_Response_type_support_symbol_names_t _Control_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_control, srv, Control_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv_control, srv, Control_Response)),
  }
};
...
{
  return &::auv_control::srv::rosidl_typesupport_cpp::Control_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auv_control, srv, Control_Response)() {
  return get_message_type_support_handle<auv_control::srv::Control_Response>();
}
...
static const _Control_type_support_symbol_names_t _Control_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_control, srv, Control)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv_control, srv, Control)),
  }
};
...
{
  return &::auv_control::srv::rosidl_typesupport_cpp::Control_service_type_support_handle;
}

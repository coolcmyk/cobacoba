...
#include "auv_control/srv/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auv_control::srv::Control_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auv_control::srv::Control_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv_control::srv::Control_Request *>(
    untyped_ros_message);
...
{
  return &auv_control::srv::typesupport_fastrtps_cpp::_Control_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = auv_control::srv::Control_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auv_control::srv::Control_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<auv_control::srv::Control_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &auv_control::srv::typesupport_fastrtps_cpp::_Control_Response__handle;
}
...
{
  return &auv_control::srv::typesupport_fastrtps_cpp::_Control__handle;
}
